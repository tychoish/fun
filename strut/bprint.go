...
func Bprint(args ...any) *Builder { var b Builder; return b.Bprint(args...) }
...
func Bprintln(args ...any) *Builder { var b Builder; return b.Bprintln(args...) }

// Bprintf formats according to tpl and returns a new Builder containing the
// result. Analogous to fmt.Sprintf.
func Bprintf(tpl string, args ...any) *Builder { var b Builder; return b.Bprintf(tpl, args...) }

// BufPrint formats args using default formatting and returns a new Buffer
// containing the result. Analogous to fmt.Sprint.
func BufPrint(args ...any) *Buffer { var b Buffer; return b.Bprint(args...) }
...
func BufPrintln(args ...any) *Buffer { var b Buffer; return b.Bprintln(args...) }

// BufPrintf formats according to tpl and returns a new Buffer containing the
// result. Analogous to fmt.Sprintf.
func BufPrintf(tpl string, args ...any) *Buffer { var b Buffer; return b.Bprintf(tpl, args...) }
