...
func Contains[T comparable](seq iter.Seq[T], cmp T) bool { return false }
...
func ChainSlices[T any](seq iter.Seq[[]T]) iter.Seq[T]   { return nil }
...
func UniqueB[K comparable, V any](seq iter.Seq[V], kfn func(V) K) iter.Seq[V]             { return nil }
...
func first[A any, B any](a A, b B) A           { return a }
func second[A any, B any](a A, b B) B          { return b }
