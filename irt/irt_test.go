...
func TestIndex(t *testing.T) {
	tests := []struct {
		name     string
		seq      iter.Seq[string]
		expected []struct{ idx int; val string }
	}{
		{
			name: "empty",
			seq:  func(yield func(string) bool) {},
		...
		},
		{
			name: "single",
			seq:  func(yield func(string) bool) { yield("a") },
			expected: []struct{ idx int; val string }{{1, "a"}},
		},
		{
			name: "multiple",
			seq:  func(yield func(string) bool) { yield("a"); yield("b"); yield("c") },
			expected: []struct{ idx int; val string }{{1, "a"}, {2, "b"}, {3, "c"}},
		},
	}
...
func TestFlip(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "single",
			seq:  func(yield func(string, int) bool) { yield("a", 1) },
			expected: []struct{ a int; b string }{{1, "a"}},
		},
		{
			name: "multiple",
			seq: func(yield func(string, int) bool) {
			...
			expected: []struct{ a int; b string }{{1, "a"}, {2, "b"}},
		},
	}
...
func TestPtrsWithNils(t *testing.T) {
	tests := []struct {
		...
		{"empty", []int{}, []*int{}},
		{"no zeros", []int{1, 2, 3}, []*int{intPtr(1), intPtr(2), intPtr(3)}},
		{"with zeros", []int{1, 0, 3}, []*int{intPtr(1), nil, intPtr(3)}},
		{"all zeros", []int{0, 0}, []*int{nil, nil}},
	}
...
func TestDeref(t *testing.T) {
	tests := []struct {
		...
		{"empty", []*int{}, []int{}},
		{"no nils", []*int{intPtr(1), intPtr(2)}, []int{1, 2}},
		{"with nils", []*int{intPtr(1), nil, intPtr(3)}, []int{1, 3}},
		{"all nils", []*int{nil, nil}, []int{}},
	}
...
func TestDerefWithZeros(t *testing.T) {
	tests := []struct {
		...
		{"empty", []*int{}, []int{}},
		{"no nils", []*int{intPtr(1), intPtr(2)}, []int{1, 2}},
		{"with nils", []*int{intPtr(1), nil, intPtr(3)}, []int{1, 0, 3}},
		{"all nils", []*int{nil, nil}, []int{0, 0}},
	}
...
func TestGenerate2(t *testing.T) {
	tests := []struct {
		name     string
		gen      func() (string, int, bool)
		expected []struct{ a string; b int }
	}{
		{
			name: "empty generator",
			gen:  func() (string, int, bool) { return "", 0, false },
		...
		},
		{
			...
			expected: []struct{ a string; b int }{{"a", 1}},
		},
	}
...
func TestWith(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			seq:  func(yield func(int) bool) { yield(1) },
			op:   func(i int) string { return string(rune('a' + i)) },
			expected: []struct{ a int; b string }{{1, "b"}},
		},
		{
			name: "multiple",
			seq:  func(yield func(int) bool) { yield(0); yield(1); yield(2) },
			op:   func(i int) string { return string(rune('a' + i)) },
			expected: []struct{ a int; b string }{{0, "a"}, {1, "b"}, {2, "c"}},
		},
	}
