...
func (l *list[T]) PushBackE(it *elem[T]) *list[T]        { l.Back().PushBack(it); return l }
func (l *list[T]) PushFrontE(it *elem[T]) *list[T]       { l.root().PushBack(it); return l }
func (l *list[T]) PushBack(it T) *list[T]                { l.PushBackE(l.newElem().Set(it)); return l }
func (l *list[T]) PushFront(it T) *list[T]               { l.PushFrontE(l.newElem().Set(it)); return l }
func (l *list[T]) Push(it T)                             { l.PushBack(it) }
func (l *list[T]) PushE(it *elem[T])                     { l.PushBackE(it) }
func (l *list[T]) Extend(seq iter.Seq[T])                { irt.Apply(seq, l.Push) }
func (l *list[T]) ExtendE(seq iter.Seq[*elem[T]])        { irt.Apply(seq, l.PushE) }
func (l *list[T]) PopBack() T                            { return l.PopBackE().Value() }
func (l *list[T]) PopFront() T                           { return l.PopFrontE().Value() }
func (l *list[T]) PopBackE() *elem[T]                    { return l.Back().Pop() }
func (l *list[T]) PopFrontE() *elem[T]                   { return l.Front().Pop() }
func (l *list[T]) IteratorFrontE() iter.Seq[*elem[T]]    { return l.nextFrom(l.Front()) }
func (l *list[T]) IteratorBackE() iter.Seq[*elem[T]]     { return l.prevFrom(l.Back()) }
func (l *list[T]) IteratorFront() iter.Seq[T]            { return l.unwrapIter(l.IteratorFrontE()) }
func (l *list[T]) IteratorBack() iter.Seq[T]             { return l.unwrapIter(l.IteratorBackE()) }
func (l *list[T]) IteratorPopFrontE() iter.Seq[*elem[T]] { return l.popIter(l.nextFrom(l.Front())) }
func (l *list[T]) IteratorPopBackE() iter.Seq[*elem[T]]  { return l.popIter(l.prevFrom(l.Back())) }
func (l *list[T]) IteratorPopFront() iter.Seq[T]         { return l.unwrapIter(l.IteratorPopFrontE()) }
func (l *list[T]) IteratorPopBack() iter.Seq[T]          { return l.unwrapIter(l.IteratorPopBackE()) }
...
func (l *list[T]) unwrapIter(seq iter.Seq[*elem[T]]) iter.Seq[T] { return irt.Convert(seq, l.toValue) }
...
func (*list[T]) cmp(fn func(T, T) int) func(*elem[T], *elem[T]) int {
	return func(lh, rh *elem[T]) int { return fn(lh.item, rh.item) }
}
...
func (l *list[T]) SortQuick(cmp func(T, T) int) {
	...
	items := irt.Collect(l.IteratorPopFrontE(), l.Len())
...
func (l *list[T]) SortMerge(cmp func(T, T) int) {
	...
	for range l.Len() / 2 {
		left.PushFrontE(l.PopFrontE())
	}

	for l.Len() > 0 {
		right.PushFrontE(l.PopFrontE())
	}
	...
	for left.Len() > 0 && right.Len() > 0 {
		if cmp(left.Front().Value(), right.Front().Value()) <= 0 {
			l.PushBackE(left.Front().Pop())
		} else {
			l.PushBackE(right.Front().Pop())
		}
	}

	// Append remaining elements
	l.ExtendE(left.IteratorPopFrontE())
	l.ExtendE(right.IteratorPopFrontE())
}
